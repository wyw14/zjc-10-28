<template>
  <div class="card">
    ...
    <div class="calendar-header">
      ...
      <div class="calendar-title" @click="togglePicker" style="cursor:pointer" title="点击快速跳转">
...
function togglePicker() {
  ...
  if (showPicker.value && props.history) {
    pickYear.value = props.history.year
    pickMonth.value = props.history.month
  }
}
